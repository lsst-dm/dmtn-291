...
Unfortunately, the same is not true of coadds; while the effective coadd PSF does depend on wavelength, much of the statistical information about the sub-band SEDs is lost in the coaddition process.
...
A generalization of that algorithm to wavelength-dependent PSFs and objects may be possible, but is well beyond the state of the art.
